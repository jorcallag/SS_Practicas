...

{
	...
	while (newframe && (key != 27)) {
...

		{
			...
			HLibreriaDll = LoadLibrary("joaalmcon-P03-Dynamic.dll"); // “Carga” la dll donde está la func.
...

			{
				...
				//y obtenemos el nombre de la funcion con su correspondiente decoración
